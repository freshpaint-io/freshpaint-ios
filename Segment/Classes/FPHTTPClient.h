...
// TODO: Make this configurable via FPAnalyticsConfiguration
// NOTE: `/` at the end kind of screws things up. So don't use it
//#define FPMENT_API_BASE [NSURL URLWithString:@"https://api-segment-io-5fsaj1xnikhp.runscope.net/v1"]
//#define FPMENT_CDN_BASE [NSURL URLWithString:@"https://cdn-segment-com-5fsaj1xnikhp.runscope.net/v1"]
#define FPMENT_API_BASE [NSURL URLWithString:@"https://api.segment.io/v1"]
#define FPMENT_CDN_BASE [NSURL URLWithString:@"https://cdn-settings.segment.com/v1"]

NS_ASSUME_NONNULL_BEGIN


NS_SWIFT_NAME(HTTPClient)
@interface FPHTTPClient : NSObject

@property (nonatomic, strong) FPRequestFactory requestFactory;
...
+ (FPRequestFactory)defaultRequestFactory;
+ (NSString *)authorizationHeader:(NSString *)writeKey;

- (instancetype)initWithRequestFactory:(FPRequestFactory _Nullable)requestFactory;
 ...
 * Completion handlers are called on a dispatch queue internal to FPHTTPClient. 
 */
