//
//  UIViewController+FPScreenTest.h
//  Analytics
//
...
#ifndef UIViewController_FPScreenTest_h
#define UIViewController_FPScreenTest_h
...
/// of `FPAnalyticsConfiguration`, which won't be set in these tests.
+ (UIViewController *)seg_topViewController:(UIViewController *)rootViewController;
@end
#endif


#endif /* UIViewController_FPScreenTest_h */
