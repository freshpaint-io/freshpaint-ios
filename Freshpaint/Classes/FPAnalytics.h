 ...
 */
@property (nullable, nonatomic, strong, readonly) FPAnalyticsConfiguration *configuration DEPRECATED_MSG_ATTRIBUTE("One time use object");
...
/**
 * Returns a dictionary of integrations that are bundled. This is an internal Freshpaint API, and may be removed at any time
 * without notice.
 */
...
/** Returns the current session info as a dictionary, sessionId and isFirstEventInSession */
