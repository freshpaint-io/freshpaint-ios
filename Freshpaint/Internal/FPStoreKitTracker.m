...
@interface FPStoreKitTracker ()

@property (nonatomic, readonly) FPAnalytics *analytics;
...
@implementation FPStoreKitTracker

+ (instancetype)trackTransactionsForAnalytics:(FPAnalytics *)analytics
{
    return [[FPStoreKitTracker alloc] initWithAnalytics:analytics];
}
